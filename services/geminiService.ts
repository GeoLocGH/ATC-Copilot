...
export const generateReadback = async (transcription: string): Promise<string> => {
  ...
  Include the aircraft callsign 'November-One-Two-Three-Alpha-Bravo' in the read-back.
